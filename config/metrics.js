      ...
      metrics: [
        {
          ...
          kind: "aggregate",
          sql: "SELECT COUNT(*) AS value FROM personnel_detail {where}",
        ...
        },
        {
          ...
          kind: "detail",
          sql: "SELECT * FROM personnel_detail {where} ORDER BY update_month DESC, employee_id",
        ...
        },
        {
          ...
          groupBy: "product",
          sql: "SELECT product, COUNT(*) AS value FROM personnel_detail {where} GROUP BY product",
        ...
        },
        {
          ...
          kind: "aggregate_group",
          groupBy: "org",
          sql: "SELECT org, COUNT(*) AS value FROM personnel_detail {where} GROUP BY org",
          allowedTimeTypes: ["month", "half_fy", "fy"],
      ...
      metrics: [
        {
          ...
          kind: "aggregate",
          sql: "SELECT COUNT(*) AS value FROM machine_info {where}",
          allowedTimeTypes: [], 
        ...
        },
        {
            ...
            kind: "detail",
            sql: "SELECT * FROM machine_info {where}",
            allowedTimeTypes: [],
            allowedFilterDimensions: ["product", "customer"],
            details: [],
        }
